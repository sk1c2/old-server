...
function HouseMenuGarage()
	...
	ClearMenu()
	selectedPage = 0
	exports['wrp-menudialog']:SetTitle("Public Garage")		
	exports['wrp-menudialog']:AddButton("Store Vehicle" , "Store Vehicle" , "RentrerVehicule")	
	exports['wrp-menudialog']:AddButton("Vehicle List" , "Vehicle List" , "ListeVehicule", 0)	
	exports['wrp-menudialog']:AddButton("Close Menu" , "Close Menu" , "CloseMenu", 0)	
end
...
AddEventHandler('garages:StoreVehicle', function()
	...
	local fuelvalue = exports["wrp-oGasStations"]:GetFuel(vehicle)
