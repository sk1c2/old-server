...
--- Config ---
notWhitelistedMessage = "Please join the discord to play on the server. Discord: https://discord.gg/4RBFqXyKYp" -- Message displayed when they are not whitelist with the role
