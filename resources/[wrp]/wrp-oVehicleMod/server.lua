...
AddEventHandler("vehicleMod:getHarness", function(plate)
    ...
    exports.ghmattimysql:execute("SELECT harness FROM __veh_mods WHERE plate = @plate", {['plate'] = plate}, function(result)
...
AddEventHandler("vehicleMod:applyHarness", function(plate, durability)
    ...
    exports.ghmattimysql:execute("UPDATE __veh_mods SET harness = @durability WHERE plate = @plate",
    {
        ['plate'] = plate,
