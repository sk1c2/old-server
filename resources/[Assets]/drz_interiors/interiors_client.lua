...
interiors = {
	...
	[39] = { ["xe"] = 224.8349914551, ["ye"] = -419.51232910151, ["ze"] = -118.19956207271, ["he"] = 0.000, ["xo"] = 238.30438232421, ["yo"] = -412.0100402831, ["zo"] = 48.11193847656, ["ho"] = 0.00, ["name"] = 'Judge Offices', ["locked"] = false },
...
function EnterXE(i)
	...
	elseif i == 19 then
		if interiors[i].locked == false then
			...
			if courthousescan or myjob == "Police" or myjob == "DOJ" then
