...
DoomsdayFacility = {
    ...
    LoadDefault = function()
        ...
        DoomsdayFacility.Lounge.Set(DoomsdayFacility.Lounge.prestige, DoomsdayFacility.Colors.utility)
        DoomsdayFacility.Sleeping.Set(DoomsdayFacility.Sleeping.prestige, DoomsdayFacility.Colors.utility)
