...
Config.Priority = {
    ...
    -- Noticed Roleplayer -- Base Prio = 10
...
-- simple localization
Config.Language = {
    joining = "\xF0\x9F\x8E\x89Joining WonderRP...",
    connecting = "\xE2\x8F\xB3Connecting to WonderRP...",
    ...
    wlonly = "\xE2\x9D\x97[URPQueue] You must be whitelisted to join this server. To apply, head to : https://discord.gg/HjVxvhJRzc",
