...
RegisterNetEvent('wrp-DRIFTSCHOOL-TAKEMONEY')
AddEventHandler('wrp-DRIFTSCHOOL-TAKEMONEY',function()
        ...
        if insideDriftSchool then
            ...
            if repairDist[1] < 5 and health < 1000.0 and veh ~= 0 and rank == 'DriftSchool' then
                ...
                if IsControlJustPressed(1, 38) then
                    TriggerEvent("wrp-DRIFTSCHOOL-TAKEMONEY")
...
RegisterNetEvent('wrp-driftschool:tookmoney')
AddEventHandler('wrp-driftschool:tookmoney', function(taken)
