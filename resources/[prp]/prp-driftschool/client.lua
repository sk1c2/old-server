...
RegisterNetEvent('prp-DRIFTSCHOOL-TAKEMONEY')
AddEventHandler('prp-DRIFTSCHOOL-TAKEMONEY',function()
        ...
        if insideDriftSchool then
            ...
            if repairDist[1] < 5 and health < 1000.0 and veh ~= 0 and rank == 'DriftSchool' then
                ...
                if IsControlJustPressed(1, 38) then
                    TriggerEvent("prp-DRIFTSCHOOL-TAKEMONEY")
...
RegisterNetEvent('prp-driftschool:tookmoney')
AddEventHandler('prp-driftschool:tookmoney', function(taken)
