...
recentconvictions = {
  ...
  "A huge increase in drug dealing has spiked in Vinewood BLVD For the product Cocaine. Police Assume it has something to do with Cole Supplying The Streets from Behind Bars."
}
...
AddEventHandler('stringGangGlobalReputations', function()
  ...
  local strg = "<font size='20'>Daily Crime News</font> <br><br> <br> <b> Cole Lucas has been sentanced to life imprisonment for multiple Murders and Running a county Line across the border. Sources Say Cole has been supplying the Streets from the inside of his cell. Police will continue to investigate his life from prison to crack down on the epidemic in the increase of drugs on the streets. "
