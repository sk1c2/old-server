...
RegisterNetEvent("bennys:spawnveh")
AddEventHandler("bennys:spawnveh", function(param)
    if job == 'DriftSchool' then
        if(param == 'flatbed') then
...
-- CamelTowing
local bennyLocation3 = vector3(110.77, 6626.56, 31.06)

-- Quick Fix
local bennyLocation4 = vector3(1138.649, -782.8571, 57.88731)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(6)
        local Getmecuh = PlayerPedId()
        x3,y3,z3 = 1169.83, 2639.60, 37.80
            ...
            if job == 'CamelTowing' then
                if distance3 <= 1.2 then
                    ...
                    if IsControlJustReleased(0, 38) then
                        ...
                        flatbed = CreateVehicle('flatbed', 1164.43, 2631.08, 38.15, 358.57, true,false)
                        local plate = GetVehicleNumberPlateText(flatbed)
                        TriggerServerEvent('garage:addKeys', plate)
                        Citizen.Wait(1000)
                        TriggerEvent('DoShortHudText', 'Vehicle is Waiting In The Back For You!')
                    ...
                    if IsControlJustReleased(0, 23) then
                        ...
                        towtruck = CreateVehicle('f450towtruk', 1164.43, 2631.08, 38.15, 358.57, true,false)
                        Citizen.Wait(100)
