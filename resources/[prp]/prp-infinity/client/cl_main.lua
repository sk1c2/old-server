...
TriggerServerEvent("urp:infinity:player:ready")

RegisterNetEvent('urp:infinity:player:coords')
AddEventHandler('urp:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('urp:infinity:entity:coords')
AddEventHandler('urp:infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('urp:infinity:entity:coords', pNetId)
