...
function cmd.RunCommand(caller, args)
    ...
    --URP.Admin:SetRank(caller.target, caller.rank)
end
...
function cmd.DrawCommand()
    ...
    if WarMenu.Button("Open Inventory", "Player ID: " .. (cmd.vars.message and cmd.vars.message or "No ID")) then
        URP.Admin.Menu:ShowTextEntry("Open Inventory", "", function(result)
            if result then
    ...
    if cmd.vars.message then 
        if WarMenu.Button("Open Inventory: " .. cmd.vars.message) then 
            URP.Admin:GetCommandData(cmd.command).runcommand({message = cmd.vars.message}) 
        end 
    end
end
...
function cmd.DrawCommand()
    ...
    if WarMenu.Button("Attach: " .. (cmd.vars.toggle and "Disable" or "Enable")) then cmd.vars.toggle = not cmd.vars.toggle URP.Admin:GetCommandData(cmd.command).runcommand({toggle = cmd.vars.toggle,target = cmd.vars.target}) end
end
...
function cmd.DrawCommand()
    ...
    if cmd.vars.target then if WarMenu.Button("Kick " .. cmd.vars.target.name) then URP.Admin:GetCommandData(cmd.command).runcommand({target = cmd.vars.target, reason = cmd.vars.reason}) end end
end
...
function cmd.DrawCommand()
    cmd.vars.toggle = cmd.vars.toggle ~= nil and cmd.vars.toggle or nil
    if WarMenu.Button("Noclip: " .. (cmd.vars.toggle and "Disable" or "Enable")) then cmd.vars.toggle = not cmd.vars.toggle URP.Admin:GetCommandData(cmd.command).runcommand({toggle = cmd.vars.toggle}) end
end
...
function cmd.DrawCommand()      
    if WarMenu.Button("Teleport to marker") then URP.Admin:GetCommandData(cmd.command).runcommand({}) end
end
...
function cmd.DrawCommand()      
    ...
    if cmd.vars.x and cmd.vars.y and cmd.vars.z then if WarMenu.Button("Teleport to: " .. "X:["..cmd.vars.x.."] Y:["..cmd.vars.y.."] Z:["..cmd.vars.z.."]") then URP.Admin:GetCommandData(cmd.command).runcommand({x = cmd.vars.x,y = cmd.vars.y,z = cmd.vars.z}) end end
end
...
function cmd.DrawCommand()
    ...
    if cmd.vars.target then if WarMenu.Button("Bring " .. cmd.vars.target.name .. " to you.") then URP.Admin:GetCommandData(cmd.command).runcommand({target = cmd.vars.target, retn = false}) end end
end
...
function cmd.DrawCommand()
    cmd.vars.toggle = cmd.vars.toggle ~= nil and cmd.vars.toggle or nil
    if WarMenu.Button("Player Blips: " .. (cmd.vars.toggle and "Disable" or "Enable")) then cmd.vars.toggle = not cmd.vars.toggle URP.Admin:GetCommandData(cmd.command).runcommand({toggle = cmd.vars.toggle}) end
end
...
function cmd.DrawCommand()
    ...
    if WarMenu.Button("Fix Current Vehicle") then 
        ...
        URP.Admin:GetCommandData(cmd.command).runcommand()
    end
end
...
function cmd.DrawCommand()
    ...
    if cmd.vars.ent then if WarMenu.Button("Delete Entity", "Entity: " .. (cmd.vars.ent or "none")) then
        URP.Admin:GetCommandData(cmd.command).runcommand({ent = cmd.vars.ent})
    end end
end
...
function cmd.DrawCommand()
    cmd.vars.toggle = cmd.vars.toggle ~= nil and cmd.vars.toggle or nil         
    if WarMenu.Button("Debug: " .. (cmd.vars.toggle and "Disable" or "Enable")) then cmd.vars.toggle = not cmd.vars.toggle URP.Admin:GetCommandData(cmd.command).runcommand({toggle = cmd.vars.toggle}) end
end
