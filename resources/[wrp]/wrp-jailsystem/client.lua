...
relogging = false
cellcoords = { 
    [1] =  { ['x'] = 1742.3341064453, ['y'] = 2491.7670898438, ['z'] = 45.573608398438, ['h'] = 300.47244262695, ['info'] = ' cell1' },
    [2] =  { ['x'] = 1744.3648681641, ['y'] = 2488.1142578125, ['z'] = 45.573608398438, ['h'] = 300.47244262695, ['info'] = ' cell2' },
    [3] =  { ['x'] = 1746.4483642578, ['y'] = 2484.6066894531, ['z'] = 45.573608398438, ['h'] = 300.47244262695, ['info'] = ' cell3' },
    [4] =  { ['x'] = 1748.3077392578, ['y'] = 2480.9802246094, ['z'] = 45.573608398438, ['h'] = 294.80316162109, ['info'] = ' cell4' },
    [5] =  { ['x'] = 1749.8110351562, ['y'] = 2477.0769042969, ['z'] = 45.573608398438, ['h'] = 300.47244262695, ['info'] = ' cell5' },
    [6] =  { ['x'] = 1768.3780517578, ['y'] = 2487.2834472656, ['z'] = 45.590454101562, ['h'] = 113.38581848145, ['info'] = ' cell6' },
    [7] =  { ['x'] = 1766.6373291016, ['y'] = 2490.8176269531, ['z'] = 45.590454101562, ['h'] = 119.0551071167, ['info'] = ' cell7' },
    [8] =  { ['x'] = 1764.3824462891, ['y'] = 2494.3911132812, ['z'] = 45.590454101562, ['h'] = 116.22047424316, ['info'] = ' cell8' },
    [9] =  { ['x'] = 1762.5626220703, ['y'] = 2497.9780273438, ['z'] = 45.590454101562, ['h'] = 110.55117797852, ['info'] = ' cell9' },
    [10] = { ['x'] = 1760.6900634766, ['y'] = 2501.9340820312, ['z'] = 45.590454101562, ['h'] = 113.38581848145, ['info'] = ' cell10' },
    [11] = { ['x'] = 1742.1362304688, ['y'] = 2491.7143554688, ['z'] = 49.583862304688, ['h'] = 303.30709838867, ['info'] = ' cell11' },
    [12] = { ['x'] = 1744.2593994141, ['y'] = 2488.1010742188, ['z'] = 49.583862304688, ['h'] = 291.96850585938, ['info'] = ' cell12' },
    [13] = { ['x'] = 1746.0791015625, ['y'] = 2484.4086914062, ['z'] = 49.583862304688, ['h'] = 300.47244262695, ['info'] = ' cell13' },
    [14] = { ['x'] = 1747.9780273438, ['y'] = 2480.7956542969, ['z'] = 49.583862304688, ['h'] = 297.63781738281, ['info'] = ' cell14' },
    [15] = { ['x'] = 1750.3385009766, ['y'] = 2477.1691894531, ['z'] = 49.583862304688, ['h'] = 297.63781738281, ['info'] = ' cell15' },
    [16] = { ['x'] = 1768.2197265625, ['y'] = 2487.3493652344, ['z'] = 49.600708007812, ['h'] = 116.22047424316, ['info'] = ' cell16' },
    [17] = { ['x'] = 1766.4000244141, ['y'] = 2490.8176269531, ['z'] = 49.600708007812, ['h'] = 119.0551071167, ['info'] = ' cell17' },
    [18] = { ['x'] = 1764.2373046875, ['y'] = 2494.24609375, ['z'] = 49.600708007812, ['h'] = 119.0551071167, ['info'] = ' cell18' },
    [19] = { ['x'] = 1761.7319335938, ['y'] = 2497.9780273438, ['z'] = 49.600708007812, ['h'] = 113.38581848145, ['info'] = ' cell19' },
    [20] = { ['x'] = 1760.5186767578, ['y'] = 2501.6044921875, ['z'] = 49.600708007812, ['h'] = 116.22047424316, ['info'] = ' cell20' },
}
...
RegisterNetEvent('urp:reclaim:possessions')
AddEventHandler('urp:reclaim:possessions', function()
...
local RECLAIM_COORDS = vector3(1841.80, 2581.29, 45.1)
...
AddEventHandler('ai:isJailBreak', function()
    TriggerEvent("chatMessagess", "DOC | Goverment | " , 1, "There is currently a jailbreak at bolingbroke , stay clear of the area or you may end up arrested or shot.")
    imjailed = false
    jailbreak = true
    runEscape()
    Wait(140000)
...
AddEventHandler('ai:prisonBreak', function()
    ...
    for i,v in ipairs(smokeLocations) do
        TriggerEvent("particle:particle:StartClientParticle",v[1],v[2],v[3],"smoke",rnd,0.0, 0.0, 0.0)
    end
...
AddEventHandler('jail:lockdown', function(lockdownState)
    ...
    if lockdown and imjailed and not hasMoved then
        ...
        TriggerEvent("chatMessagess", "DOC | " , 2, "You have been placed into lockdown due to a disturbance.")
        hasMoved = true
    elseif not lockdown and imjailed then
        hasMoved = false
        TriggerEvent("chatMessagess", "DOC | " , 2, "Lockdown has ended.")
    end
end)
...
function JailIntro(years,name,cid,date)
    ...
    Citizen.Wait(1500) 
    DoScreenFadeIn(500)
    local prop = TriggerEvent("attachItemCONLOL","con1",name,years,cid)
...
function RoleplayStats()
    ...
    if math.random(70) < totalroleplay then
        ...
        Wait(1000)
        TriggerServerEvent("jail:cuttime", math.random(10,15), exports['isPed']:isPed('cid'))
    else
        TriggerServerEvent("jail:cuttime", 4, exports['isPed']:isPed('cid'))
    end
...
AddEventHandler('beginJail', function(time,name,cid, skipintake)
    imjailed = false
    ...
    TriggerServerEvent("updateJailTime",minutes, exports['isPed']:isPed('cid'))
    imjailed = true
    ...
    TriggerEvent("inhotel",false)
        ...
        TriggerServerEvent("updateJailTime",0, exports['isPed']:isPed('cid'))
    ...
    while true do
        ...
        if (#(GetEntityCoords(playerPed, 0) - vector3(1832.01,2580.54, 46.02)) < 4.0) then
            ...
            if IsControlJustPressed(1, Controlkey["generalUse"][1]) and not SwappingCharacters then
                ...
                TriggerServerEvent("checkJailTime", exports['isPed']:isPed('cid'))
                Citizen.Wait(5000)
            end
...
AddEventHandler('TimeRemaining', function(TimeRemaining, release)
    ...
    if TimeR <= 0 and release then 
       imjailed = false
        ...
        SetEntityCoords(PlayerPedId(), 1841.89, 2594.42,46.02)
       
    end

    -- local minutes = math.ceil(TimeR / 60)
    TriggerEvent("chatMessage", "DOC | " , 4, "You have " .. TimeR .. " months remaining")
end)
...
RegisterCommand('jail', function(source, args)
    ...
    if exports['isPed']:isPed('job') == 'Police' then
        if args[1] then
            ...
            TriggerEvent('DoLongHudText', 'There are no players with this ID', 2)
        end
    end
end)