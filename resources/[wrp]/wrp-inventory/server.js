            ...
            switch (itemid.toLowerCase()) {
                case "idcard":
                    if (itemdata == itemdata) {
                        let string = `SELECT first_name,last_name,gender,dob FROM __characters WHERE id = '${player}'`;
...
onNet("wrp-ac:triggeredItemSpawn", async (coords, player, secondInventory, targetName, itemToDropArray, sauce) => {
    ...
    //    emitNet('current-items', src, invArray)
        ...
        if (secondInventory == "1") {
            ...
            var shopAmount = 14;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "82") {
            var targetinvname = targetName;
            var shopArray = VendingMachines();
            var shopAmount = 2;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
            ...
            var targetinvname = targetName;
            var shopArray = BurgerShotDrinks();
            var shopAmount = 4;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "513") {
            var targetinvname = targetName;
            var shopArray = IatraRestrauntDrinks();
            var shopAmount = 5;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "600") {
            var targetinvname = targetName;
            var shopArray = policevending();
            var shopAmount = 3;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "600") {
            var targetinvname = targetName;
            ...
            var targetinvname = targetName;
            var shopArray = PillboxNoneEMS();
            var shopAmount = 1;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "86") {
            var targetinvname = targetName;
            var shopArray = WhiteWidow();
            var shopAmount = 4;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
            ...
            var targetinvname = targetName;
            var shopArray = TunerShopBoss();
            var shopAmount = 5;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "714") {
            var targetinvname = targetName;
            var shopArray = LostMC();
            var shopAmount = 4;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "6969") {
            var targetinvname = targetName;
            var shopArray = SkyHighEnterprise();
            var shopAmount = 1;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);       
