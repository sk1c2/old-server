function URP.Util.MissionText(self, text, time)
...
function URP.Util.DrawText(self, text, font, centre, x, y, scale, r, g, b, a)
    SetTextFont(font)
    SetTextProportional(0)
    SetTextScale(scale, scale)
    SetTextColour(r, g, b, a)
...
function URP.Util.DrawText3D(self, x,y,z, text)
