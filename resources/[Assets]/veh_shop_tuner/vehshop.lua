...
--				{name = "Sold/Reserved", description = ''},
		...
		["sports"] = {
			...
			buttons = {
				...
				{model = "zx10", name = "Kawasaki Ninja ZX10R", costs = 60000, description = {} }, 
				{model = "banshee2", name = "Banshee 900R", costs = 160000, description = {} }, 
				{model = "dc5", name = "Honda Integra Type R", costs = 280000, description = {} },
				{model = "eclipse", name = "Mitsubishi Eclipse GSX", costs = 230000, description = {} },
				{model = "filthynsx", name = "Acura NSX LW", costs = 600000, description = {} },
				{model = "bdragon", name = "Bentley CGT Dragon", costs = 800000, description = {} },
				{model = "por930", name = "Porsche 911 930", costs = 135000, description = {} },
				{model = "gtrc", name = "Mercedes AMG GTR", costs = 250000, description = {} },
				{model = "e36prb", name = "BMW M3 E36", costs = 150000, description = {} },
				{model = "cp9a", name = "Mitsubishi Lancer Evolution VI GSR TME", costs = 300000, description = {} },
				{model = "hellion6str", name = "Hellion V2", costs = 200000, description = {} },
				{model = "na1", name = "Honda NSX NA1", costs = 200000, description = {} },
				{model = "gtr", name = "Nissan GTR R35", costs = 475000, description = {} },
				{model = "raid", name = "Dodge Challenger Raid", costs = 135000, description = {} },
				{model = "500gtrlam", name = "Diablo GTR", costs = 610000, description = {} },
				{model = "lwlp670", name = "Lamborghini Murcielago LW LP670", costs = 550000, description = {} },
				{model = "granlb", name = "Maserati Gran Turismo LW", costs = 350000, description = {} },
				{model = "bluecunt", name = "Holden HSV", costs = 45000, description = {} },
				{model = "mbw124", name = "Mercedes W124 300D", costs = 86000, description = {} },
				{model = "hoabrawler", name = "Brawler", costs = 70000, description = {} },
				{model = "dabneon", name = "DC Neon", costs = 150000, description = {} },
				{model = "m3e46", name = "BMW M3 GTR", costs = 200000, description = {} },
				{model = "esv", name = "Cadillac Escalade", costs = 130000, description = {} },
				...
				{model = "zr3806str", name = "6STR ZR380", costs = 220000, description = {} }, 
				{model = "ellie6str", name = "6STR Ellie", costs = 260000, description = {} }, 
				{model = "gauntlet6str", name = "6STR Gauntlet", costs = 650000, description = {} }, 
				{model = "ladybird6str", name = "6STR Ladybird", costs = 590000, description = {} }, 
				{model = "ruiner6str", name = "6STR Ruiner", costs = 220000, description = {} }, 
				{model = "schwarzer2", name = "6STR Schwartzer", costs = 180000, description = {} }, 
				{model = "sentinel6str2", name = "6STR Sentinel Classic", costs = 180000, description = {} }, 
				{model = "tempesta2", name = "6STR Tempesta", costs = 460000, description = {} }, 
				{model = "golfp", name = "VW Pandem Golf R", costs = 200000, description = {} }, 
				{model = "c63", name = "Mercedes C63 AMG", costs = 430000, description = {} },
				{model = "m4", name = "BMW LW M4", costs = 250000, description = {} }, 
				{model = "rcf", name = "Lexus RCF", costs = 80000, description = {} }, 
				{model = "rudiharley", name = "Harley Fatboy", costs = 45000, description = {} }, 
				{model = "sanctus", name = "Sanctus", costs = 40000, description = {} },
				{model = "deathbike", name = "Deathbike", costs = 23500, description = {} },
				{model = "shotaro", name = "Shotaro", costs = 100000, description = {} }, 
				{model = "deviant", name = "Deviant", costs = 250000, description = {} },
				{model = "stafford", name = "Stafford", costs = 56000, description = {} },
				{model = "m5e60", name = "BMW E60 M5", costs = 300000, description = {} },
				{model = "r35", name = "Nissan GTR R35", costs = 375000, description = {} },
				{model = "pigalle6str", name = "6STR Pigalle", costs = 125000, description = {} }, 
				...
				{model = "stratumc", name = "Zircoflow Stratum", costs = 95000, description = {} },
				{model = "m235", name = "BMW M235", costs = 80000, description = {} },
				{model = "futo2", name = "6STR Futo", costs = 59500, description = {} }, 
				{model = "tampa5", name = "6STR Drift Tampa V2", costs = 650000, description = {} },
				{model = "fc3s", name = "Mazda RX7 FC", costs = 200000, description = {} },
				{model = "er34", name = "Nissan Skyline ER34", costs = 275000, description = {} },
				{model = "lwgtr", name = "Liberty Walk GTR", costs = 600000, description = {} },
				{model = "z190custom", name = "Z190D", costs = 85600, description = {}},
				{model = "lp700r", name = "Lamborghini Aventador LP700R", costs = 300000, description = {}},
				{model = "911turbos", name = "Porsche 911 Turbo S", costs = 200000, description = {}},
				{model = "rx7rb", name = "Mazda RX7 RB", costs = 350000, description = {}},
				{model = "subwrx", name = "Subaru Impreza WRX", costs = 190000, description = {}},
				{model = "rmodmustang", name = "Ford Mustang RMod", costs = 650000, description = {}},
				{model = "delsoleg", name = "Honda Civic EG", costs = 125000, description = {}},
				{model = "ap2", name = "Honda S2000", costs = 48500, description = {}},
				{model = "evo10", name = "Mitsubishi Lancer Evolution X MR FQ-400", costs = 200000, description = {}},
				{model = "acs8", name = "BMW i8", costs = 300000, description = {}},
				{model = "510", name = "Datsun 510", costs = 150000, description = {}},
				{model = "a80", name = "Toyota Supra Mk.IV", costs = 156200, description = {}},
				{model = "370Z", name = "Nissan 370Z", costs = 65000, description = {}},
				{model = "66fastback", name = "1966 Ford Mustang", costs = 65320, description = {}},
				{model = "E46", name = "BMW M3 E46", costs = 68500, description = {}},
				{model = "na6", name = "Mazda MX5 NA", costs = 25000, description = {}},
				{model = "mustang19", name = "2019 Ford Mustang", costs = 46000, description = {}},
				{model = "r1", name = "Yamaha R1", costs = 62500, description = {}},
				{model = "audirs6tk", name = "Audi RS6", costs = 235000, description = {}},
				{model = "gt63", name = "Mercedes AMG GT63", costs = 425000, description = {}},
				{model = "69charger", name = "1969 Dodge Charger", costs = 86500, description = {}},
				{model = "c7", name = "Corvette C7", costs = 76500, description = {}},
				{model = "650slw", name = "McLaren 650S LW", costs = 750000, description = {}},
				{model = "fnfrx7", name = "Mazda RX7 FD3S", costs = 85000, description = {}},
				{model = "fk8", name = "Honda Civic Type-R FK8", costs = 200000, description = {}},
				{model = "focusrs", name = "Ford Focus RS", costs = 250000, description = {}},
				{model = "f150", name = "Ford Raptor F150", costs = 50000, description = {}},
				{model = "srt8b", name = "Jeep Grand Cherokee SRT8", costs = 170000, description = {}},
				{model = "panamera17turbo", name = "Porsche Panamera Turbo", costs = 200000, description = {}},
				{model = "exor", name = "Camaro ZL1", costs = 120000, description = {}},
				{model = "gt3rs", name = "Porsche 911 GT3RS", costs = 315000, description = {}},
				{model = "skyline", name = "Nissan Skyline R34", costs = 285000, description = {}},
				{model = "a6", name = "Audi A6", costs = 45000, description = {}},
				{model = "rrst", name = "Range Rover Vogue", costs = 95000, description = {}},
				{model = "CTSV16", name = "Cadillac CTSV16", costs = 60000, description = {}},
				{model = "brz", name = "Subaru BRZ", costs = 92000, description = {}},
				{model = "nzp", name = "Nissan 370Z Drift", costs = 160000, description = {}},
				{model = "bnrpandem", name = "Nissan R32", costs = 150000, description = {}},
				{model = "vivio", name = "Subaru Vivio", costs = 20000, description = {}},
				{model = "HDIron883", name = "LostMC Bike", costs = 35000, description = {}},
				{model = "ar8lb", name = "Audi R8 Liberty Walk", costs = 280000, description = {}},
				{model = "sentinel6str", name = "Drift Sentinal", costs = 200000, description = {}},
			}
		}
	}
}
...
function BuyMenu()
	for i = 1, #carspawns do
		...
		if #(vector3(carspawns[i]["x"],carspawns[i]["y"],carspawns[i]["z"]) - GetEntityCoords(PlayerPedId())) < 2.0 then
			...
			if IsControlJustReleased(0,74) and buyPlate[addplate] ~= nil then
...
--		print("financed")
	...
	Citizen.Wait(100)
	TaskWarpPedIntoVehicle(PlayerPedId(),veh,-1)
	TriggerServerEvent('CheckMoneyForVeh69',name, model, price, financed, exports['isPed']:isPed('cid'), pdmdealer)
	...
	if bool and #vehshop_blips == 0 then
		...
		Citizen.CreateThread(function()
			while #vehshop_blips > 0 do
				...
				local myJob = exports['isPed']:isPed('job')
				if myJob == 'tuner_carshop' then
					if #(vector3(945.9429, -949.2361, 39.49981) - GetEntityCoords(LocalPed())) < 5.0 then
						local veh = GetVehiclePedIsUsing(LocalPed())
						--if myspawnedvehs[veh] ~= nil then
							DrawText3D(945.9429, -949.2361, 39.49981,"["..Controlkey["generalUse"][2].."] Return Vehicle")
							DrawMarker(36,945.9429, -949.2361, 39.49981, 0, 0, 0, 0, 0, 0, 1.0, 1.0, 1.0, 255,105,180, 35, 1, 1, 2, 0, 0, 0, 0)
