...
AddEventHandler('towgarage:triggermenu', function(degradation,eHealth,bHealth)
	...
	if targetVehicle ~= nil  and targetVehicle ~= 0 then
		...
		local strng = "<br> Brakes (Rubber) - " .. round(degHealth["breaks"] / 10,2) .. "/10.0" .. " <br> Axle (Scrap) - " .. round(degHealth["axle"] / 10,2) .. "/10.0" .. " <br> Radiator (Scrap) - " .. round(degHealth["radiator"] / 10,2) .. "/10.0" .. " <br> Clutch (Scrap) - " .. round(degHealth["clutch"] / 10,2) .. "/10.0" .. " <br> Transmission (Aluminium) - " .. round(degHealth["transmission"] / 10,2) .. "/10.0" .. " <br> Electronics (Plastic) - " .. round(degHealth["electronics"] / 10,2) .. "/10.0" .. " <br> Injector (Copper) - " .. round(degHealth["fuel_injector"] / 10,2) .. "/10.0" .. " <br> Fuel (Steel) - " .. round(degHealth["fuel_tank"] / 10,2) .. "/10.0" .. " <br> Body (Glass) - " .. round((bodyHealth / 10) / 10,2) .. "/10.0" .. " <br> Engine (Scrap) - " .. round((engineHealth / 10) / 10,2) .. "/10.0"
